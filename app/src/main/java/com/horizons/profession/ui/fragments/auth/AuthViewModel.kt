...
@Inject constructor(
    ...
    fun isValidParams(country_code: String,phone: String?, pass: String?): Boolean {
    ...
    fun login(country_code: String,phone: String, pass: String) {
