    ...
    * */
    ...
    fun buildAlertMessageNoGps(
        ...
        val show = MaterialAlertDialogBuilder(context)
            .setTitle(context.getString(com.horizons.profession.R.string.location_is_off))
            .setMessage(context.getString(com.horizons.profession.R.string.location_off_body_message))
            .setPositiveButton(com.horizons.profession.R.string.yes) { dialog, _ ->
                dialog.dismiss()
                locationLauncher?.launch(Intent(Settings.ACTION_LOCATION_SOURCE_SETTINGS))
            }
            .setNegativeButton(com.horizons.profession.R.string.no) { dialog, _ ->
                dialog.dismiss()
            }.show()
    }
